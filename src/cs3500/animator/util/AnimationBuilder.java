...
/**
 * Represents an builder that creates a shape animation. Supports operations such as setting bounds
 * of an animation, creating shapes, adding motions and adding key frames to an animation.
 *
